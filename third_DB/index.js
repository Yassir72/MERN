...
//   .then((createdproducts)=>console.log('Product created Successfully : ',createdproducts))
//   .catch((error)=>console.log('Error creating user : ',error))

ProductModel.find()
            .sort({price : 1})
            .then((element)=>console.log("Products Sorted : ",element));

// ProductModel.find()
//             .limit(5)
//             .then((element)=>console.log("products : ",element))

function custompage(pagesize,pagenum){
    ProductModel.find()
...
//                                     count : {$sum : 1}}
//                         }])
//             .then((element)=>console.log(element[0].count))

// ProductModel.aggregate([{
//                         $group : {_id : "",
//                                     averagePrice : {$avg : "$price"}}
//                         }])
//             .then((element)=>console.log(element[0].averagePrice))
